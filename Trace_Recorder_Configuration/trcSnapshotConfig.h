 ...
 * it may store. Most events use one record (4  uint8_t), although some events
 * require multiple 4- uint8_t records. You should adjust this to the amount of RAM
 * available in the target system.
 *
 * Default value is 1000, which means that 4000  uint8_ts is allocated for the
 * event buffer.
 */
 ...
 * @brief Macro which should be defined as an integer value.
 *
 * This defines the capacity of the symbol table, in  uint8_ts. This symbol table
 * stores User Events labels and names of deleted tasks, queues, or other kernel
 * objects. If you don't use User Events or delete any kernel
 * objects you set this to a very low value. The minimum recommended value is 4.
 * A size of zero (0) is not allowed since a zero-sized array may result in a
 * 32-bit pointer, i.e., using 4  uint8_ts rather than 0.
 *
 ...
 * below 16 MB (2^24  uint8_t), and you can live with reported addresses showing the
 ...
 *
 * NOTE: An object with handle above 255 will use an extra 4- uint8_t record in
